...
EDIT: I have done what I said I wanted to do, to wit I have made a CelebA dataset to which I added roughly 30K JR images (around 1000 unique ones which were cropped by hand to suit the CelebA set), and used the [Snellius cluster](https://hpc.uva.nl/Why-/article/115/Dutch-National-Supercomputer-Snellius) to train around 60 epochs. The trained model can be found [Here](https://huggingface.co/rubenlier/VAESnellius)
. The result is given below: 

![continuum](results/morph_roster_roberts_new.gif)
